...
2. **Verifique se o banco já resolve.** Antes de propor invariante na aplicação, confira `CHECK`, unique parcial, exclusion constraint e RLS — [[PostgreSQL com Drizzle ORM]].
