...
| 29 / 30 / 31 min | just "a lot of time passed" — does not catch `>` × `>=` | boundary value, [Teste de Software - Técnicas de Design de Caso](../../../../knowledge-base/teste-de-software-tecnicas-de-design-de-caso.md) |
