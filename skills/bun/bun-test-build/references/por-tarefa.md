...
| --- | --- | --- |
| escrever teste, escolher matcher, modificador, snapshot | [[Bun - Testes - Escrita e Asserções]] | — |
| substituir dependência: mock, spy, duplo | [[Bun - Testes - Mocks e Tempo]] | § 5.2 |
| congelar data, avançar timer, fuso | [[Bun - Testes - Mocks e Tempo]] | § 5.3 |
| testar componente React, DOM, interação | [[Bun - Testes - DOM e Componentes]] | § 5.6 |
| hooks, preload, escopo de setup | [[Bun - Testes - Ciclo de Vida e Isolamento]] | — |
| `bunfig.toml [test]`, descoberta, filtros | [[Bun - Testes - Execução e Configuração]] | — |
| cobertura, reporter, workflow de CI | [[Bun - Testes - Cobertura e CI]] | § 5.5 |
| vim do Jest ou do Vitest | [[Bun - Testes]] § 5.4 (mapa de equivalência) | § 5.4 |
...
Verifique a receita completa em [[Bun - Testes - DOM e Componentes]] § 2 antes de escrever a primeira linha — ela tem quatro peças, e três falham em silêncio se faltarem:
...
1. `bunfig.toml`, seção `[test]` — a superfície completa está em [[Bun - Testes - Execução e Configuração]] § 5.
...
Receita em [[Bun - Testes - Cobertura e CI]] § 5. As decisões que não são negociáveis:
...
- [[Bun - Testes]] § 5 — as árvores de decisão
