...
| Falha intermitente sem padrão de ordem | `await` faltando, ou timer real | [[Bun - Testes - DOM e Componentes]] § 3 |
...
| Todos os testes verdes e exit ≠ 0 | erro não tratado fora de teste | [[Bun - Testes - Execução e Configuração]] § 6 |
| `beforeAll` falhou e o relatório mostra "skip" | erro de hook pula o escopo inteiro | [[Bun - Testes - Ciclo de Vida e Isolamento]] § 2 |
...
- [[Bun - Testes]] § 5.1 — a árvore de flaky completa
