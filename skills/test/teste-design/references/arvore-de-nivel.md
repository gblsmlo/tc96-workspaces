...
> Passos 1 a 3 da skill. A árvore completa é a § 4.1 de [[Teste de Software]]; aqui está o
...
| o formato que atravessa a fronteira com um sistema que não é meu | **contrato** — e boa parte é o compilador | [[Hono - Validação e RPC]] · [[Elysia - Schema e Eden]] |
...
| tipo incompatível, uso incorreto de API | **estático** | [[TypeScript]] |
...
- [[Teste de Software]] § 4.1 — a árvore completa
- [[Teste de Software - Níveis e Escopo]] — a fonte
