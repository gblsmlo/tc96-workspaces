...
DOCS="$BASE/docs"
OUT="$PLUGIN/skills/tanstack-query/references/mapa-de-ids.md"
...
{
  echo "---"
  echo "gerado-por: plugins/hermes-frontend/skills/tanstack-query/scripts/gerar-mapa-de-ids.sh"
  ...
  echo "> Regenerar com \`bash plugins/hermes-frontend/skills/tanstack-query/scripts/gerar-mapa-de-ids.sh\`."
  echo
