...
familia: playwright
idioma: en
fonte: "[Playwright - Locators](../../../knowledge-base/playwright-locators.md)"
docs:
...
> **Source of this skill:** [Playwright - Locators](../../../knowledge-base/playwright-locators.md) and [Playwright - Assertions](../../../knowledge-base/playwright-assertions.md), with the [Playwright](../../../knowledge-base/playwright.md) hub as the router. The 85 rules of the `PW-*` family live in § 6 of the hub, with the full body in the satellite that owns each ID.
...
| wiring test agents into the repository | [Playwright - Agents, CLI e MCP](../../../knowledge-base/playwright-agents-cli-e-mcp.md) |
...
| Order | Load | Why |
| --- | --- | --- |
| 1 | [Playwright](../../../knowledge-base/playwright.md) § 0 | the Node floor and the timeout table — `actionTimeout` is `0`, not 30 s |
| 2 | [Playwright](../../../knowledge-base/playwright.md) § 2 | a locator is a lazy query; the waiting belongs to the tool |
| 3 | [Playwright](../../../knowledge-base/playwright.md) § 6 and § 6.1 | the inviolable rules and the satellites' critical ones |
| 4 | [Playwright - Locators](../../../knowledge-base/playwright-locators.md) | no test exists without a locator |
| 5 | [Playwright - Assertions](../../../knowledge-base/playwright-assertions.md) | the inseparable pair of step 4 |
...
- [Playwright - Locators](../../../knowledge-base/playwright-locators.md) — source of this skill
- [Playwright - Assertions](../../../knowledge-base/playwright-assertions.md) — the second source, inseparable from the first
- [Playwright](../../../knowledge-base/playwright.md) — the hub: § 0, § 2, § 5, § 6, § 7
