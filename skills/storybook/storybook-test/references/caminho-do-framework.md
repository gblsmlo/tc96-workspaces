...
| --- | --- | --- |
| `@storybook/tanstack-react` | **A** | [Storybook - TanStack React](../../../../knowledge-base/storybook-tanstack-react.md) · family `SB-TS-*` |
| `@storybook/react-vite` | **B** | [Storybook - React Vite](../../../../knowledge-base/storybook-react-vite.md) · family `SB-RV-*` |
...
**The two families are mutually exclusive.** Citing `SB-TS-*` against a `react-vite` project is an invalid finding, and vice versa — and `SB-TS-03`/`SB-RV-05` and `SB-TS-08`/`SB-RV-06` are **pairs by path**, not canonical and alias ([Storybook](../../../../knowledge-base/storybook.md) § 6.2).
