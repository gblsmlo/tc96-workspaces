...
| --- | --- | --- |
| `@storybook/tanstack-react` | **A** | [Storybook - TanStack React](../../../../knowledge-base/docs/storybook-tanstack-react.md) · família `SB-TS-*` |
| `@storybook/react-vite` | **B** | [Storybook - React Vite](../../../../knowledge-base/docs/storybook-react-vite.md) · família `SB-RV-*` |
...
**As duas famílias são mutuamente exclusivas.** Citar `SB-TS-*` contra um projeto `react-vite` é achado inválido, e vice-versa — e `SB-TS-03`/`SB-RV-05` e `SB-TS-08`/`SB-RV-06` são **pares por caminho**, não canônico e apelido ([Storybook](../../../../knowledge-base/docs/storybook.md) § 6.2).
