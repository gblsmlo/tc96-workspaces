...
| --- | --- | --- | --- |
| `storybook-setup` | `.storybook/`, `vite.config.ts`, versões | [Storybook - Configuração e Builder](../../knowledge-base/docs/storybook-configuracao-e-builder.md) | 5 referências + 2 scripts |
| `storybook-story` | `*.stories.tsx` — o `meta`, os `args`, as tags | [Storybook - Stories e Args](../../knowledge-base/docs/storybook-stories-e-args.md) | 5 referências + 1 script |
| `storybook-test` | a `play` dentro da story, mock, a11y | [Storybook - Testes e Interações](../../knowledge-base/docs/storybook-testes-e-interacoes.md) | 6 referências + 1 script |
...
- [Skill — Índice](../README.md) · [Storybook](../../knowledge-base/docs/storybook.md) § 7 — o contrato
- `hermes-core: família teste` — decide o nível, antes destas
- [Storybook - Cobertura e CI](../../knowledge-base/docs/storybook-cobertura-e-ci.md) — o lado operacional, consultado direto
