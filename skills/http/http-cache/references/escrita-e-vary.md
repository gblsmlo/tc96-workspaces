...
> **Ponte com o cliente:** o `412` é um **erro esperado**, não uma exceção — ele é estado da UI ("alguém editou; recarregar?"), não caso para Error Boundary. Ver `REACT-ASYNC-09` em [[React - Suspense e Assincronia]] e o update otimista de [[TanStack Query - Mutations e Invalidação]], que precisa de rollback quando o `412` chega.
