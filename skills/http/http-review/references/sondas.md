...
**S3 is the most likely to light up in this stack:** in Hono, without the `methodNotAllowed` middleware, an unsupported method returns `404` ([Hono - Middleware e Ciclo de Vida](../../../../knowledge-base/hono-middleware-e-ciclo-de-vida.md) § 5).
