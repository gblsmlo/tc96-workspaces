...
1. **Turn a probe into a test.** S3, S4, S5 and S6 are verifiable in an API test — `Docs/Playwright - Rede e Mocking.md` § 5. A finding that only exists in the report comes back in six months (`TS-CORE-06` in [Teste de Software](../../../../knowledge-base/docs/teste-de-software.md)).
