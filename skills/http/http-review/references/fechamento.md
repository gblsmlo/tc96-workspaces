...
1. **Transforme sonda em teste.** S3, S4, S5 e S6 são verificáveis em teste de API — [[Playwright - Rede e Mocking]] § 5. Achado que só existe no relatório volta em seis meses (`TS-CORE-06` em [[Teste de Software]]).
