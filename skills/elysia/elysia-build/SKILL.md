...
| --- | --- | --- |
| 1 | [[Elysia]] § 2 | **uma declaração de schema produz quatro efeitos** — é o modelo mental |
| 2 | [[Elysia]] § 3 | fronteiras de import, e os **dois escopos npm** que coexistem |
| 3 | [[Elysia]] § 6 + § 6.1 + § 6.2 | regras, críticas e IDs canônicos |
| 4 | [[Elysia - Roteamento e Handler]] | a fonte |
| 5 | [[Elysia]] § 5 ("Como devolvo um erro?") | a árvore de erro |
...
Cookie de sessão **assinado e `httpOnly`** (`ELYSIA-CORE-05`); a semântica de `SameSite` e prefixos é de [[RFC 6265 - Cookies HTTP]]. Em stream, `set.headers` depois do primeiro `yield` é **silenciosamente ignorado** (`ELYSIA-CORE-06`) — e o `idleTimeout` do `Bun.serve` derruba SSE por conta própria.
...
- [[Elysia - Roteamento e Handler]] — fonte desta skill
- [[Elysia]] § 2, § 5, § 6, § 7 — modelo mental, árvores, regras, contrato
