...
> **Fonte desta skill:** [React - Patterns](../../../knowledge-base/docs/react-patterns.md) (decisão estrutural), com [React - Rules of React](../../../knowledge-base/docs/react-rules-of-react.md) como base normativa e [React.js](../../../knowledge-base/docs/react-js.md) como roteador de API.
...
Conforme [React.js](../../../knowledge-base/docs/react-js.md) § 7:
...
De [React - Patterns](../../../knowledge-base/docs/react-patterns.md) § 1. A ordem importa: composição escolhida antes da posse do dado quase sempre gera prop drilling.

1. **De quem é este dado?** → colocação de estado. Detalhe em [React - Patterns](../../../knowledge-base/docs/react-patterns.md) § 2.
2. **Quem fornece o conteúdo variável?** → composição. Detalhe em [React - Patterns](../../../knowledge-base/docs/react-patterns.md) § 3.
3. **Onde uma falha ou uma espera deve parar?** → fronteiras (Error Boundary, `<Suspense>`, `'use client'`, servidor). Detalhe em [React - Patterns](../../../knowledge-base/docs/react-patterns.md) § 6.
...
Não escolha o Hook por hábito. Percorra a árvore correspondente em [React.js](../../../knowledge-base/docs/react-js.md) § 5 — o roteiro, os erros de percurso e as quatro saídas curtas estão em `references/arvores-de-decisao.md`.
...
Depois de escolher a API, confirme o pacote de origem em [React.js](../../../knowledge-base/docs/react-js.md) § 3 e o satélite em [React.js](../../../knowledge-base/docs/react-js.md) § 4. Abra **só esse** satélite.

**Antes de usar a primitiva crua, confira [React.js](../../../knowledge-base/docs/react-js.md) § 8.** Dado remoto, cache, estado de URL, validação de fronteira e estado global de escrita frequente já têm resposta no stack — usar `useEffect` + `useState` onde o stack resolve é regressão, não simplicidade.

---

## Passo 3 — Escrever

Mantenha [React - Rules of React](../../../knowledge-base/docs/react-rules-of-react.md) carregada. Três âncoras do modelo mental ([React.js](../../../knowledge-base/docs/react-js.md) § 2) decidem quase tudo:
...
| --- | --- | --- |
| `fetch` dentro de `useEffect` | biblioteca de data fetching ([React.js](../../../knowledge-base/docs/react-js.md) § 8) | `REACT-EFFECT-06` |
| `useState` + `useEffect` para valor calculável | calcular no render, no dono do estado | `REACT-PAT-01` |
| `useState` para filtro, aba, paginação | search params do [TanStack Router](../../../knowledge-base/docs/tanstack-router.md) | `REACT-PAT-10` |
...
```bash
bash ${CLAUDE_PLUGIN_ROOT}/skills/react-developer/scripts/autoverificar.sh src/features/faturas
```


1. **Checklist normativa** — a § 5 de [React - Rules of React](../../../knowledge-base/docs/react-rules-of-react.md), ordenada por frequência de falha.
...
Antes de escrever a primitiva crua, confirme de quem é a camada. [React.js](../../../knowledge-base/docs/react-js.md) § 8 lista o que o stack já resolve; a tabela abaixo diz **qual skill** carrega o procedimento.
...
| rota, navegação, search params, loader, code splitting | `tanstack-router` | [TanStack Router](../../../knowledge-base/docs/tanstack-router.md) |
| formulário com validação, campo condicional, array de campos | `react-hook-form` | [React Hook Form](../../../knowledge-base/docs/react-hook-form.md) |
...
- [React - Patterns](../../../knowledge-base/docs/react-patterns.md) — fonte desta skill
- [React - Rules of React](../../../knowledge-base/docs/react-rules-of-react.md) — base normativa, obrigatória ao escrever
- [React.js](../../../knowledge-base/docs/react-js.md) — hub, mapa da API, árvores de decisão, pontes com o stack
