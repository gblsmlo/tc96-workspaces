...
Precedência normativa, de [React.js](../../../../knowledge-base/docs/react-js.md) § 7 (invariante 3) e [React - Rules of React](../../../../knowledge-base/docs/react-rules-of-react.md) § 6.
...
| **Alta** | regras críticas de [React.js](../../../../knowledge-base/docs/react-js.md) § 6.1 — `REACT-EFFECT-06`, `REACT-PAT-03`, `REACT-ASYNC-08`, `REACT-RSC-06`, `REACT-DOM-01`… | bug latente: race condition, tela branca, endpoint sem autorização |
...
Quatro partes, sempre. O formato vem de [React.js](../../../../knowledge-base/docs/react-js.md) § 7 ("Como citar").
...
Antes de reportar, verifique se existe ID em [React.js](../../../../knowledge-base/docs/react-js.md) § 6, § 6.1, § 6.2, em `mapa-de-ids.md`
...
2. **Não existe ID, mas é antipadrão documentado** (`index` como `key`, Context com escrita
 frequente — ambos em [React - Patterns](../../../../knowledge-base/docs/react-patterns.md) § 8) → reporte citando a **seção**, nunca um ID
 inventado: "antipadrão de [React - Patterns](../../../../knowledge-base/docs/react-patterns.md) § 8".
...
**Nunca invente um ID.** Se uma API não aparece em [React.js](../../../../knowledge-base/docs/react-js.md) § 4, ela não foi verificada nesta
doc: consulte react.dev, **declare a limitação** e proponha atualizar a nota — não afirme
comportamento ([React.js](../../../../knowledge-base/docs/react-js.md) § 7, invariante 1).
...
2. **Verifique se o stack já resolve.** Antes de sugerir a primitiva crua, confira as pontes de
 [React.js](../../../../knowledge-base/docs/react-js.md) § 8 — dado remoto é `tanstack-query`, estado de URL é `tanstack-router`.
