...
tags:
  ...
  - testing
fontes:
  - "[Teste de Software](../knowledge-base/docs/teste-de-software.md)"
  - "[Playwright](../knowledge-base/docs/playwright.md)"
  - "[Bun - Testes](../knowledge-base/docs/bun-testes.md)"
  - "[Storybook - Testes e Interações](../knowledge-base/docs/storybook-testes-e-interacoes.md)"
---
# qa-engineer
...
| --- | --- | --- |
| 1 | [Teste de Software](../knowledge-base/docs/teste-de-software.md) § 6 e § 6.2 | regras `TS-*` e IDs canônicos — a base de qualquer decisão |
| 2 | [Teste de Software - Níveis e Escopo](../knowledge-base/docs/teste-de-software-niveis-e-escopo.md) | árvore de nível e proporção por módulo |
| 3 | a skill da tarefa | procedimento |
| 4 | o hub da ferramenta — [Playwright](../knowledge-base/docs/playwright.md), [Bun - Testes](../knowledge-base/docs/bun-testes.md), [Storybook](../knowledge-base/docs/storybook.md) | § 6.2 de IDs (`PW-*`, `BUN-TEST-*`, `SB-*`) |
...
3. Derive os casos com as técnicas de [Teste de Software - Técnicas de Design de Caso](../knowledge-base/docs/teste-de-software-tecnicas-de-design-de-caso.md): valor limite onde há faixa (`TS-TEC-01`), partição de equivalência, tabela de decisão.
4. Escolha o dublê pelo nome certo — dummy, stub, fake, mock ou spy (`TS-DUB-01`, [Teste de Software - Dublês de Teste](../knowledge-base/docs/teste-de-software-dubles-de-teste.md)) — e **nunca** substitua por dublê aquilo que o teste existe para provar (`TS-CORE-03`).
...
- **Playwright** (`playwright-build`): locator por papel e nome acessível (`PW-LOC-01`); asserção web-first (`PW-EXP-01`); setup reusado é fixture (`PW-FIX-01`); estrutura de UI por `toMatchAriaSnapshot` antes de screenshot (`PW-SNAP-01`); autenticação por `storageState` isolado ([Playwright - Autenticação e Isolamento](../knowledge-base/docs/playwright-autenticacao-e-isolamento.md)); rede mockada só na fronteira que o teste **não** prova ([Playwright - Rede e Mocking](../knowledge-base/docs/playwright-rede-e-mocking.md)). Autoverificação de 12 itens antes de entregar.
- **bun test** (`bun-test-build`): arquivo casa o padrão de descoberta (`BUN-TEST-01`); `spyOn` com restauração garantida (`BUN-TEST-02`); `mock.module` em `--preload` porque não é desfeito por `mock.restore` (`BUN-TEST-03`); tempo controlado ([Bun - Testes - Mocks e Tempo](../knowledge-base/docs/bun-testes-mocks-e-tempo.md)); isolamento ([Bun - Testes - Ciclo de Vida e Isolamento](../knowledge-base/docs/bun-testes-ciclo-de-vida-e-isolamento.md)).
...
- `test-review` mede a **forma**: nove sondas de distribuição, duração, portões e classes de risco descobertas. Forma *ice-cream cone* é achado (`TS-NIV-04`). Cobertura e CI: [Teste de Software - Confiabilidade da Suíte](../knowledge-base/docs/teste-de-software-confiabilidade-da-suite.md), [Bun - Testes - Cobertura e CI](../knowledge-base/docs/bun-testes-cobertura-e-ci.md), [Playwright - Execução, Retries e CI](../knowledge-base/docs/playwright-execucao-retries-e-ci.md), [Storybook - Cobertura e CI](../knowledge-base/docs/storybook-cobertura-e-ci.md).
...
3. **Ferramenta**: `juros.test.ts` com relógio controlado ([Bun - Testes - Mocks e Tempo](../knowledge-base/docs/bun-testes-mocks-e-tempo.md)); `FaturaResumo.stories.tsx` com `play` afirmando o texto por papel acessível.
...
- [Teste de Software](../knowledge-base/docs/teste-de-software.md) — hub: regras `TS-*`, § 6.2 de IDs canônicos
- [Skills](../skills/README.md) — as duas camadas de skill de teste e a tabela de desambiguação
- [Playwright](../knowledge-base/docs/playwright.md) · [Bun - Testes](../knowledge-base/docs/bun-testes.md) · [Storybook](../knowledge-base/docs/storybook.md) — hubs das ferramentas
