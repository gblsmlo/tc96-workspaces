...
| Dono | Percurso em [[React.js]] § 5 | Saída | Regra |
| --- | --- | --- | --- |
| faturas | "o dado vem do servidor?" → sim | [[TanStack Query]], não `useState` + `useEffect` | `REACT-PAT-03`, `REACT-EFFECT-06` |
| filtro | sobrevive a refresh, é compartilhável por link, respeita o voltar | search params do [[TanStack Router]] | `REACT-PAT-10` |
...
| `key={i}` na lista | antipadrão de [[React - Patterns]] § 8 |
