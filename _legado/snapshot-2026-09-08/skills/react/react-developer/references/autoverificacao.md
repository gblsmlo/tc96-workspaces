...
Ordenada por frequência de falha. É a mesma da § 5 de [[React - Rules of React]] —
...
1. Todo `useState` que sobrou responde "sim" à árvore de estado de [[React.js]] § 5,
...
- [[React - Rules of React]] § 5 — a checklist normativa, com o texto das regras
