...
Contrato que esta skill implementa: [[Feature-Based Architecture]] § 10, que por sua vez implementa [[React.js]] § 7.
...
Adaptado de [[Feature-Based Architecture]] § 10 — a linha `SOB DEMANDA` é acréscimo desta skill:
...
Ordem normativa ([[Feature-Based Architecture]] § 10). Responda **por escrito**, uma frase cada, antes do primeiro `mkdir`: é um domínio? o domínio já existe? o dado é remoto? isto é público? quem vai importar isto?
...
Rode a checklist de [[Feature-Based Architecture]] § 10 na íntegra: barrel, direção de dependência, invalidação de `queryKey`, teste colocalizado, convenção de nome. **Ela não verifica alias** — isso é do Passo 6; se você mexeu em `paths`, confira os três arquivos à mão.
...
- [[Feature-Based Architecture]] — fonte desta skill: estrutura, regras `REACT-ARCH-*`, enforcement
- [[Architecture in React]] — roteador dos demais eixos de decisão arquitetural
...
- [[React.js]] § 7 — o contrato de skill original
