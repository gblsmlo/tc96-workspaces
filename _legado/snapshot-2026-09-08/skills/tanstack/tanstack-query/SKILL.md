...
Antes de tudo, passe pela primeira árvore de [[TanStack Query]] § 5 ("Este dado é da Query?"):
...
| estado global de cliente com escrita frequente | [[Zustand]] |
...
```bash
bash ~/.claude/skills/tanstack-query/scripts/sondas.sh src
```
...
- [[TanStack Query]] — fonte desta skill: § 2, § 4, § 5, § 7
