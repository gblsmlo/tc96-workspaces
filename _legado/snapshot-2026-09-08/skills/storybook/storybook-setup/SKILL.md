...
| Ordem | Carregar |
| --- | --- |
| 1 | [[Storybook]] § 5.1 (a árvore de framework) e § 6.2 (as famílias mutuamente exclusivas) |
| 2 | [[Storybook - Configuração e Builder]] |
| 3 | a nota do **caminho escolhido**: [[Storybook - TanStack React]] ou [[Storybook - React Vite]] |
...
3. Story → [[storybook-story]]; teste dentro dela → [[storybook-test]]; cobertura e CI → [[Storybook - Cobertura e CI]].
...
- [[Storybook - Configuração e Builder]] — fonte desta skill
- [[Storybook]] § 5.1, § 6.2, § 7
- [[storybook-story]] · [[storybook-test]] — as skills irmãs
- [[Storybook - TanStack React]] · [[Storybook - React Vite]] — as duas notas de caminho
