...
**Cubra os cinco estados de um fluxo:** carregando, vazio, sucesso, erro, recuperação. É `TS-TIPO-02` em [[Teste de Software - Tipos e Atributos de Qualidade]], e no nível de componente eles são baratos — é aqui que se paga menos por cobrir o que o usuário mais sofre.
