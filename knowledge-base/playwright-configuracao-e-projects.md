...
No stack deste vault isso é o caso normal: `apps/web` e `apps/server` sobem juntos ([Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md)). O `name` é o que torna o log legível quando os dois falham.
...
- [Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md) — dois `webServer` e onde a suíte vive
