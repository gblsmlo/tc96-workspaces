...
>
> **Não cobre:** o porquê conceitual de validar configuração · a API geral do Zod · onde segredos devem morar em produção · `strict` e resolução de módulos.
...
pelo mecanismo da plataforma ou por um gerenciador de segredos — ver
 e
. O módulo de validação é o mesmo nos
