...
```
SEMPRE:   Elysia.md § 2 (modelo mental)
          Elysia.md § 5 (árvores de decisão)
          Elysia.md § 6 + § 6.1 (regras normativas e críticas)

AO ESCREVER/EDITAR rotas e respostas:
          Elysia - Roteamento e Handler.md

AO ESCREVER plugin, hook, auth, ou ao investigar
"o plugin não está sendo aplicado":
          Elysia - Lifecycle e Plugins.md

AO DECLARAR schema, response, OpenAPI,
ou ao consumir a API no frontend:
          Elysia - Schema e Eden.md

EM CONSUMO PELO REACT:
          Elysia.md § 8 + Elysia - Schema e Eden.md § 7
