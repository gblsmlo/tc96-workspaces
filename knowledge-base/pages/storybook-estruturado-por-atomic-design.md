...
> A referência de API do Storybook — CSF, `args`, `play`, runner — é [Storybook](../docs/storybook.md); esta nota não a
...
`SB-CSF-03` em [Storybook](../docs/storybook.md) diz isso explicitamente: `title` é a hierarquia, e ele é literal.
...
mecanismo que `SB-TS-08` / `SB-RV-06` descrevem para acoplamento a rota em [Storybook](../docs/storybook.md) — a story
...
> **Estas regras são desta nota**, não da § 6 de [Storybook](../docs/storybook.md). Ao citar num review, diga a origem
...
- [Storybook](../docs/storybook.md) — a referência de API: CSF, `args`, `play`, runner, e as famílias `SB-*` da § 6
- [Feature-Based Architecture](feature-based-architecture.md) — nota irmã: onde o código mora e quem importa quem
- [Storybook - Stories e Args](../docs/storybook-stories-e-args.md) — como a story é escrita depois que a camada foi decidida
- [Storybook - Docs e Autodocs](../docs/storybook-docs-e-autodocs.md) — o catálogo como documentação
