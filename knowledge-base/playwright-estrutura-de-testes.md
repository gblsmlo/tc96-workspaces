...
- **`e2e/` fora de `src/`.** A suíte E2E é consumidora da aplicação, não parte dela — a direção de dependência é só num sentido. Num monorepo, é um pacote folha ([Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md)).
...
- [Feature-Based Architecture](feature-based-architecture.md) · [Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md) — onde `e2e/` vive
- ·
