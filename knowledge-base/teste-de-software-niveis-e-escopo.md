...
> **No stack deste vault, boa parte do teste de contrato é feita pelo compilador.** Quando o cliente importa o tipo exportado do servidor ([Hono - Validação e RPC](hono-validacao-e-rpc.md), [Elysia - Schema e Eden](elysia-schema-e-eden.md)), uma mudança de shape quebra o build em vez de quebrar em runtime. Isso é teste de contrato estático, e é a forma mais barata que existe.
>
...
| shape que atravessa a fronteira | contrato — em boa parte estático | [Hono - Validação e RPC](hono-validacao-e-rpc.md), [Elysia - Schema e Eden](elysia-schema-e-eden.md) |
...
- [Hono - Validação e RPC](hono-validacao-e-rpc.md) · [Elysia - Schema e Eden](elysia-schema-e-eden.md) — contrato como tipo
