...
Isso é a mesma direção de dependência de [Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md) § 2 vista de outro ângulo, e o mesmo critério de [React - Patterns](react-patterns.md) sobre o que pertence a um componente reutilizável (`SB-TS-08`).
...
- [Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md) — a direção de dependência que a § 10 invoca
