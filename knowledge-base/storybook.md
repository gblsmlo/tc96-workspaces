...
**O caso guia é `packages/ui`**, o pacote de design system do monorepo descrito em [Monorepo com Bun - estrutura e tooling](monorepo-com-bun-estrutura-e-tooling.md): componentes puros, reutilizáveis, sem acoplamento a rota. Stories acopladas a rota são o assunto de [Storybook - TanStack React](storybook-tanstack-react.md).
...
```
SEMPRE:   Storybook.md § 2 (modelo mental)
          Storybook.md § 5 (árvores de decisão)
          Storybook.md § 6 + § 6.1 (regras normativas e críticas)

AO ESCREVER/EDITAR arquivo de stories:
          Storybook - Stories e Args.md
...
AO CONFIGURAR o projeto, ou em qualquer story que toque rota:
          Storybook - TanStack React.md   (se framework = @storybook/tanstack-react)
          Storybook - React Vite.md       (se framework = @storybook/react-vite)
