...
```
SEMPRE:   Bun.md § 2 (modelo mental)
          Bun.md § 3 (fronteiras de import)
          Bun.md § 5 (árvores de decisão)
          Bun.md § 6 + § 6.1 (regras normativas e críticas)

AO ESCREVER código de aplicação:
          Bun - Runtime e APIs.md

AO TOCAR package.json, lockfile, CI ou monorepo:
          Bun - Gerenciador de Pacotes.md
