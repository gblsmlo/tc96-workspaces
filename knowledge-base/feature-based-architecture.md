...
IDs citáveis, no mesmo formato de [React - Rules of React](react-rules-of-react.md). Um achado de revisão cita o ID, o
...
virtuais em vez de desmontar as features — ver [TanStack Router - Virtual File Routes](tanstack-router-virtual-file-routes.md).
...
Antipadrões de React (não de arquitetura) ficam em [React - Patterns](react-patterns.md) § 8.
...
Implementa o contrato de [React.js](react-js.md) § 7. Uma skill de estrutura deriva **desta nota**, não da doc
...
TAMBÉM:              [React - Patterns](react-patterns.md) para decisão de componente
...
- [React.js](react-js.md) — hub de React e § 7, o contrato de skill
- [TanStack Router - Virtual File Routes](tanstack-router-virtual-file-routes.md) — quando a rota colide com a feature
