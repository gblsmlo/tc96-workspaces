...
| Playwright | `route`, `addInitScript`, `clock` | `Playwright - Rede e Mocking` |
...
`TS-DUB-05`. As APIs concretas: `Playwright - Rede e Mocking` § 7 e `Bun - Testes - Mocks e Tempo`.
...
- `Bun - Testes - Mocks e Tempo` · [Storybook - Mocking](storybook-mocking.md) · `Playwright - Rede e Mocking` — as ferramentas por nível
