...
Cada um custa segundos e um browser. A regra pertence a teste unitário; o E2E cobre que a tela mostra o valor calculado. Ver e [Teste de Software](teste-de-software.md).
