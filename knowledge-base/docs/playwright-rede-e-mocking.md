...
O mock passa, a aplicação real quebra. Reuse o tipo do servidor — `Hono - Validação e RPC`, `Elysia - Schema e Eden` (`PW-NET-04`).
...
- `Hono - Validação e RPC` · `Elysia - Schema e Eden` — de onde vem o tipo da resposta
