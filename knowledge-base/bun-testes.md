...
```
SEMPRE:   Bun - Testes.md § 2 (modelo mental)
          Bun - Testes.md § 3 (fronteiras de import)
          Bun - Testes.md § 6.1 (o caminho mínimo)

AO ESCREVER teste novo:
          Bun - Testes - Escrita e Asserções.md

AO SUBSTITUIR dependência (mock, spy, duplo) ou controlar tempo:
          Bun - Testes - Mocks e Tempo.md   +   § 5.2 / § 5.3

AO DIAGNOSTICAR "passa sozinho, falha na suíte" ou flaky:
          § 5.1   +   Bun - Testes - Ciclo de Vida e Isolamento.md

AO TESTAR componente React:
          Bun - Testes - DOM e Componentes.md

AO MEXER em CI, cobertura ou reporter:
          Bun - Testes - Cobertura e CI.md

AO CONFIGURAR o projeto do zero:
          Bun - Testes - Execução e Configuração.md § 5
          + Bun - Testes - DOM e Componentes.md § 2 (se houver componente)
