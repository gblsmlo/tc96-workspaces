...
```
SEMPRE:   React Hook Form.md § 2 (modelo mental)
                                  § 5 (árvores de decisão)
                                  § 6 + § 6.1 (regras)
...
- · · ·
- [TanStack Query - Mutations e Invalidação](tanstack-query-mutations-e-invalidacao.md) · [Frontend roadmap](frontend-roadmap.md)
